...
VL_INLINE_OPT void VALU___024root___ico_sequent__TOP__0(VALU___024root* vlSelf) {
    ...
    if (((((((((0U == (IData)(vlSelf->select)) | (1U 
        ...
        vlSelf->alu_out = (0xffffU & ((0U == (IData)(vlSelf->select))
                                       ? ((IData)(vlSelf->in_a) 
                                          + (IData)(vlSelf->in_b))
                                               ...
                                               : ((3U 
                                                  ...
                                                  ((4U 
                                                   ...
                                                   ((5U 
                                                     == (IData)(vlSelf->select))
                                                     ? 
                                                    VL_SHIFTL_III(16,16,16, (IData)(vlSelf->in_a), (IData)(vlSelf->in_b))
                                                     : 
                                                    ((6U 
                                                      == (IData)(vlSelf->select))
                                                      ? 
                                                     VL_SHIFTR_III(16,16,16, (IData)(vlSelf->in_a), (IData)(vlSelf->in_b))
                                                      : 
                                                     (((IData)(vlSelf->in_a) 
                                                       > (IData)(vlSelf->in_b))
                                                       ? 1U
...
#endif
            VL_FATAL_MT("rtl/ALU.sv", 1, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("rtl/ALU.sv", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("rtl/ALU.sv", 1, "", "Active region did not converge.");
            }
