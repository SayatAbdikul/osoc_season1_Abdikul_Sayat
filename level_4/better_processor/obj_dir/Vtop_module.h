...
#ifndef VERILATED_VTOP_MODULE_H_
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_module VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    Vtop_module___024root* const rootp;
    ...
    explicit Vtop_module(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vtop_module(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vtop_module();
  private:
    VL_UNCOPYABLE(Vtop_module);  ///< Copying not allowed
