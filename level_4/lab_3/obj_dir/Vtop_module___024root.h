...
class alignas(VL_CACHE_LINE_BYTES) Vtop_module___024root final : public VerilatedModule {
  public:
    ...
    SData/*15:0*/ top_module__DOT__reg_s;
    SData/*15:0*/ top_module__DOT__reg_c;
