...
VL_INLINE_OPT void Valu___024root___nba_sequent__TOP__0(Valu___024root* vlSelf) {
    ...
    vlSelf->out_valid = ((1U & (~ (IData)(vlSelf->rst))) 
                         && (IData)(vlSelf->alu__DOT__in_valid_r));
    vlSelf->alu__DOT__in_valid_r = ((1U & (~ (IData)(vlSelf->rst))) 
...
#endif
            VL_FATAL_MT("alu.sv", 8, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("alu.sv", 8, "", "Active region did not converge.");
            }
